...
@Repository("mblMyCarBookMngDAO")
public class MblMyCarBookMngDAO extends EgovComAbstractDAO {
	...
	public List<MblMyCarBookMngVO> selectMblMyCarBookMng(MblMyCarBookMngVO mblMyCarBookMngVO) throws Exception {
        return (List<MblMyCarBookMngVO>) list("mblMyCarBookMngDAO.selectMblMyCarBookMng", mblMyCarBookMngVO);
    }
