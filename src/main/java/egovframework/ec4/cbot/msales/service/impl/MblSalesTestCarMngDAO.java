...
@Repository("mblSalesTestCarMngDAO")
public class MblSalesTestCarMngDAO extends EgovComAbstractDAO {
	...
	public List<MblSalesTestCarMngVO> selectMblSalesTestCarMng(MblSalesTestCarMngVO mblSalesTestCarMngVO) throws Exception {
        return (List<MblSalesTestCarMngVO>) list("mblSalesTestCarMngDAO.selectMblSalesTestCarMng", mblSalesTestCarMngVO);
    }
