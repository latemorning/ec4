...
@Repository("mblSalesBrochMngDAO")
public class MblSalesBrochMngDAO extends EgovComAbstractDAO {
	...
	public List<MblSalesBrochMngVO> selectMblSalesBrochMng(MblSalesBrochMngVO mblSalesBrochMngVO) throws Exception {
        return (List<MblSalesBrochMngVO>) list("mblSalesBrochMngDAO.selectMblSalesBrochMng", mblSalesBrochMngVO);
    }
