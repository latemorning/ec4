...
@Repository("mblMembInfoMngDAO")
public class MblMembInfoMngDAO extends EgovComAbstractDAO {
	...
	public List<MblMembInfoMngVO> selectMblMembInfoMng(MblMembInfoMngVO mblMembInfoMngVO) throws Exception {
        return (List<MblMembInfoMngVO>) list("mblMembInfoMngDAO.selectMblMembInfoMng", mblMembInfoMngVO);
    }
