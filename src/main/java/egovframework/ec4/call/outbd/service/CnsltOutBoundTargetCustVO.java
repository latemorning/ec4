...
public class CnsltOutBoundTargetCustVO extends DetailCodeVO{
    ...
    private ArrayList<CnsltOutBoundTargetCustVO> listCnsltTargetCustTable = null;
    private ArrayList<CnsltOutBoundTargetCustVO> listTargetCustAsignTable = null;
	...
	public ArrayList<CnsltOutBoundTargetCustVO> getListTargetCustAsignTable() {
		return listTargetCustAsignTable;
	}

	public void setListTargetCustAsignTable(ArrayList<CnsltOutBoundTargetCustVO> listTargetCustAsignTable) {
		this.listTargetCustAsignTable = listTargetCustAsignTable;
	}
	...
	public ArrayList<CnsltOutBoundTargetCustVO> getListCnsltTargetCustTable() {
		return listCnsltTargetCustTable;
	}

	public void setListCnsltTargetCustTable(ArrayList<CnsltOutBoundTargetCustVO> listCnsltTargetCustTable) {
		this.listCnsltTargetCustTable = listCnsltTargetCustTable;
	}

	List <CnsltOutBoundTargetCustVO> cnsltOutBoundTargetCustList;


	/**
	 * cnsltOutBoundTargetCustList attribute 를 리턴한다.
	 * @return List<CnsltOutBoundTargetCustVO>
	 */
	public List<CnsltOutBoundTargetCustVO> getCnsltOutBoundTargetCustList() {
		return cnsltOutBoundTargetCustList;
	}

	/**
	 * ec4SalesLeadRegMngList attribute 값을 설정한다.
	 * @param cnsltOutBoundTargetCustList List<CnsltOutBoundTargetCustVO>
	 */
	public void setCnsltOutBoundTargetCustList(List<CnsltOutBoundTargetCustVO> cnsltOutBoundTargetCustList) {
		this.cnsltOutBoundTargetCustList = cnsltOutBoundTargetCustList;
	}
