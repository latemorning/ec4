...
public class JFileVO implements JFileDetails {
	...
	private String[] deletedFileSeqList = null;
	...
	public String[] getDeletedFileSeqList() {
		return deletedFileSeqList;
	}
	public void setDeletedFileSeqList(String[] deletedFileSeqList) {
		this.deletedFileSeqList = deletedFileSeqList;
	}
