...
//		return "egovframework/com/uss/umt/EgovDeptManageList";
	...
	public String insertDeptManage(@ModelAttribute("deptManageVO") DeptManageVO deptManageVO, @ModelAttribute("deptManage") DeptManageVO deptManage, BindingResult bindingResult, SessionStatus status, ModelMap model) throws Exception {

		if(null == deptManageVO) deptManage = deptManageVO;
