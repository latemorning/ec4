...
public class EgovQustnrRespondInfoController {
    ...
    public String egovQustnrRespondInfoManageRegist(@ModelAttribute("searchVO") ComDefaultVO searchVO, @RequestParam Map commandMap, HttpServletRequest request, ModelMap model)
            throws Exception {

        //String[] test = request.getParameterValues("QQESTN_0000000000012");
        //String[] test = (String[])commandMap.get("QQESTN_0000000000012");
        ...
        if (sCmd.equals("save")) {
            ...
            for (Object key : commandMap.keySet()) {
                ...
                if (sKey.length() > 6 && sKey.substring(0, 6).equals("QQESTN")) {
                    ...
                    System.out.println("key -> " + key + " commandMap.get(key) -> " + commandMap.get(key));
                    ...
                    if (commandMap.get("TY_" + key).equals("1")) {
                        ...
                        if (paramMap.get(key).length > 1) {
                            ...
                            String[] arrVal = (String[])paramMap.get(key);
                            ...
                            for (int g=0 ; g<arrVal.length ; g++) {
                                ...
                                qustnrRespondInfoVO.setQustnrRespondId((String)commandMap.get("searchCstmrEsntlId")); // 2018.07.31 harry
            ...
            qustnrRespondManageVO.setQustnrRespondId((String)commandMap.get("searchCstmrEsntlId"));
            ...
            //sLocationUrl = "forward:/uss/olp/qnn/EgovQustnrRespondInfoManageList.do"; // 원래 소스(설문목록)
            sLocationUrl = "forward:/ec4/call/outbd/cnslt/outbdCnsltMng.do";            // 아웃바운드 설문화면
