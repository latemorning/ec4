...
public class QustnrManageDao extends EgovComAbstractDAO {
    ...
    public List<CmmnDetailCode> selectQustnrCombo(ComDefaultVO searchVO) throws Exception {

        return (List<CmmnDetailCode>)list("QustnrManage.selectQustnrCombo", searchVO);
    }
}
