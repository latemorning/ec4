...
var AXInputConverter = Class.create(AXJ, {
	...
	bindDate: function (objID, objSeq) {
		...
		var separator = ((obj.config.separator === undefined) ? ((AXConfig.AXInput.dateSeparator === undefined) ? "-" : AXConfig.AXInput.dateSeparator) : obj.config.separator);
...
//	},
    ...
    // twinDate(v1.81 가져옴 : 2017-07-18 정용우)
    bindTwinDate: function (objID, objSeq, option) {
        var cfg = this.config;
        var obj = this.objects[objSeq];
