...
<!-- Main content -->
    <section class="content">
      <div id="cnsltMainDiv" class="row">
		...
		<!-- ############################# 메인화면 ######################  -->
        	<div id="custDiv" class="col-md-7"> <!-- DIV 가로영역을 나누는 용도 -->
        		  <div id="callBtn">
					...
					<div id="postnTable" class="row">
			            <div class="col-md-2">
						    <a href="#" class="thumbnail">
						      <img src="/images/egovframework/ec4/call/callTimeSample.png" alt="...">
						    </a>
			            </div>
			            <div class="col-md-10">
			            	<!-- 검색항목 -->
		                    <div class="row">
				                    <form class="form-horizontal">
				                    	...
				                    	<div class="form-group dstick">
			                                ...
			                                <div>
			                                	<button type="button" class="btn btn-info" data-toggle="modal" data-target="#vehicInfoModal"> 조회</button>
			                                </div>
				                    	</div>
				                    </form>
		                    </div>
                  		...
                  		<div class="col-md-12"> <!-- DIV 가로영역을 나누는 용도 -->
                  			<form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="text02" class="col-sm-3 control-label">고객관계</label>
                                    <div class="col-sm-3">
                                        <select class="form-control" name="select2" id="select2">
                                            <option>고객관계</option>
                                            <option>option 2</option>
                                ...
                                <div class="form-group">
                                    <label for="text01" class="col-sm-3 control-label">상담구분</label>
                                    <div class="col-sm-3">
                                        <select class="form-control" name="select2" id="select2">
                                            <option>상담구분</option>
                                            <option>option 2</option>
                                    ...
                                    <label for="text02" class="col-sm-3 control-label">상담결과</label>
                                    <div class="col-sm-3">
                                        <select class="form-control" name="select2" id="select2">
                                            <option>상담결과</option>
                                            <option>option 2</option>
                                ...
                                <div class="form-group">
                                    <label for="textarea2" class="col-sm-3 control-label">기타조치<br>내용</label>
                                    <div class="col-sm-9">
