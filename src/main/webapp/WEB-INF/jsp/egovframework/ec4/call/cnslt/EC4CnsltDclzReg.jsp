...
$(document).ready(function(){
    ...
    $("#btnUpdate").click(function(){
        ...
        var rowData = cnsltDclzTable.rows(".selected").data();
        if(rowData[0]){
            params.makrCd = rowData[0].makrCd;
            params.attendDt = rowData[0].attendDt;
            params.cnsltUserId = rowData[0].cnsltUserId;
        }
        
        // 수정 팝업 오픈
        fn_cnsltDclz_mod_popup(params);
    });
            ...
            if(confirm('<spring:message code="common.delete.msg"/>')){
                ...
                if(!params.cnsltUserId){
                    ...
                    $.ajax({
                        ...
                        "url": "<c:url value='/ec4/call/cnslt/deleteCnsltDclz.do'/>",
                        "data": params,
...
//등록 팝업 오픈
function fn_cnsltDclz_reg_popup(params){

 $("div.modal-content").load("<c:url value='/ec4/call/cnslt/cnsltDclzRegPopup.do'/>", params, function(response, status, xhr) {
...
//수정 팝업 오픈
function fn_cnsltDclz_mod_popup(params){

	if(params.cnsltUserId){

     $("div.modal-content").load("<c:url value='/ec4/call/cnslt/cnsltDclzModPopup.do'/>", params, function(response, status, xhr) {
                ...
                <div class="box">
                    ...
                    <form class="form-horizontal">
                            <div class="form-group">
                                <label for="searchAttendDt" class="col-sm-2 control-label">근태일자</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label for="searchOrgnztId" class="col-sm-2 control-label">상담원부서</label>
                                <div class="col-sm-2">
        	...
        	<div class="col-xs-12"> <!-- DIV 가로영역을 나누는 용도 -->
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                                <button type="button" id="btnExcel" class="btn btn-info"> 액셀</button>
