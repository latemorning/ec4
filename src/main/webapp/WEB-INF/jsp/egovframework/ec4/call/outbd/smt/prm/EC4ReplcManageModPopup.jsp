...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // 수정 ajax
        $("#btnReplcManageUpdateAction").click(function(){
            ...
            $.ajax({
                ...
                "url": "<c:url value='/ec4/call/outbd/smt/prm/updateReplcManage.do'/>",
    ...
    // end ready
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">정비소 수정 팝업</h4>
            </div>
            <div class="modal-body">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-fw fa-save"></i>정비소 수정</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <!-- form start -->
                        <form:form commandName="replcManageVO" name="replcManageVO" method="post">
                            <div class="row">
                                <div class="form-group has-warning col-md-6">
                                    ...
                                    <form:input path="replcCode" cssClass="form-control input-sm" readonly="true" />
                                </div>
                                <div class="form-group has-warning col-md-6">
                                    ...
                                    <form:errors cssClass="help-block" path="replcTy"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group has-warning col-md-6">
                                    ...
                                    <form:errors cssClass="help-block" path="replcNm"/>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group has-warning col-md-6">
                                    ...
                                    <form:errors cssClass="help-block" path="smsDsptchNo"/>
                                </div>
                                <div class="form-group col-md-6">
                    ...
                    <div class="box-footer text-right">
                        <button type="button" id="btnReplcManageUpdateAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                    </div>
                    <!-- /.box-footer -->
                </div>
                <!-- /.box -->
