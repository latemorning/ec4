...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#btnInsertAction").click(function(){
            ...
            var url = "/ec4/call/outbd/smt/cgm/insertGoodsManage.do";
            ...
            <div class="modal-body">
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-footer text-right">
                        <button type="button" id="btnInsertAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                    </div>
                    <!-- /.box-footer -->
                </div>
                <!-- /.box -->
