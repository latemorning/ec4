...
<%
  ...
  * @Description : EC4CnsltInBoundStat List 화면
...
$(document).ready(function(){
    ...
    callCnsltTable = $('#callCnsltTable').DataTable({
        ...
        "searching": false,
        "bServerSide": true,
        "sAjaxSource": "<c:url value='/ec4/call/inbd/selectCallCnsltInBoundStatList.do'/>",
        ...
        "columns": [
            {"data":"rn"},                                          // 0
            {"data":"cnsltDt" , "defaultContent" : ""},                                 // 1   1
            {"data":"cnsltTeamNm" , "defaultContent" : ""},                               // 2   1
            {"data":"callTypeNm" , "defaultContent" : ""},                                   // 3
            {"data":"cnsltKndNm" , "defaultContent" : ""},                                     // 4
            {"data":"cnsltCnt" , "defaultContent" : ""},                             // 5
            {"data":"cnsltEndCnt" , "defaultContent" : ""},                           // 6   4   1
            {"data":"cnsltIngCnt" , "defaultContent" : ""},                                // 7   5
            {"data":"cnsltReqCnt" , "defaultContent" : ""},                                // 8   5
            {"data":"cnsltVocCnt" , "defaultContent" : ""},                                // 9   5
            {"data":"repairResvCnt" , "defaultContent" : ""},                                // 10   5
            {"data":"salesLeadCnt" , "defaultContent" : ""},                                // 11   5
            {"data":"mktNoAgreeCnt" , "defaultContent" : ""}                                // 12   5
        ]
    });
