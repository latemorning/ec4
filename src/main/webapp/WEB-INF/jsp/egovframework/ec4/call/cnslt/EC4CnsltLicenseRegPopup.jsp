...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCnsltLicenseInsertAction").click(function(){
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>상담원자격증 등록</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            <form:hidden path="makrCd"/>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
		                                ...
		                                <div class="control-label">
		                                        <form:input path="licenseNo" cssClass="form-control input-sm"/>
		                                </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCnsltLicenseInsertAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
