...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCallQuestUpdateAction").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/call/outbd/updateCallQuest.do'/>",
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>질문스크립트 수정</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            <form:hidden path="questType"/>
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCallQuestUpdateAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
