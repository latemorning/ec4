...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCnsltDclzUpdateAction").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/call/cnslt/updateCnsltDclz.do'/>",
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>상담원근태 수정</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            <form:hidden path="workOutTime"/>
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCnsltDclzUpdateAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
