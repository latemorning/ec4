                ...
                <div class="box">
                    ...
                    <form class="form-horizontal">
                            <div class="form-group">
                                <label for="searchCustNm" class="col-sm-2 control-label">평가일자</label>
                                <div class="col-sm-2">
				          ...
				          <table class="table table-hover">
				            ...
				            <tbody>
				            	<tr>
				            		...
				            		<td>홍길동</td>
				            		<td>
				            			<input type="text" name="text01" class="form-control" id="text01" value="2018-04-30"/>
				            		</td>
				            		<td>
				            		...
				            		<td>
				            			<input type="text" name="text01" class="form-control" id="text01" value="70"/>
				            		</td>
				            	</tr>
				          	</tbody>
				          </table>
