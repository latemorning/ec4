            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
				                    <form class="form-horizontal">
				                    	...
				                    	<div class="form-group">
			                                ...
			                                <div class="col-sm-2 dstick">
			                                	<input type="text" class="form-control" id="lastReadKm" name="lastReadKm"/>
			                                </div>
				                    	</div>
		                                <div class="form-group">
			                            ...
			                            <div class="form-group">
			                                ...
			                                <div class="col-sm-10 dstick">
				                                ...
				                                <input type="text" name="adresDetail" class="form-control" id="adresDetail"/>
			                                </div>
									  	</div>
		                                <div class="form-group">
				                    	...
				                    	<div class="form-group">
			                                <label for="callerNm" class="col-sm-2 control-label">의뢰인</label>
			                                <div class="col-sm-2 dstick">
			                                	<input type="text" class="form-control" id="callerNm"/>
			                                </div>
			                                <label for="callerTelNo" class="col-sm-2 control-label">연락처</label>
			                                <div class="col-sm-2 dstick">
			                                	<input type="text" class="form-control" id="callerTelNo"/>
			                                </div>
				                    	</div>
				                    </form>
							<!-- 고객정보항목 THE END <<<<<<<<<<<  -->
                    ...
                    <!-- /.box-header -->
			            	<!-- 검색항목 -->
				                    <form class="form-horizontal">
				                    	...
				                    	<div class="form-group">
			                                <label for="cmplSittnCd" class="col-sm-2 control-label">차량상태</label>
			                                <div class="col-sm-10">
												<input type="text" class="form-control" id="searchCallType"/>
			                                </div>
				                    	</div>
				                    	<div class="form-group">
			                                <label for="searchCallType" class="col-sm-2 control-label">위치</label>
			                                <div class="col-sm-10">
			                                	<input type="text" name="emailAdres" class="form-control" id="emailAdres"/>
			                                </div>
				                    	</div>
                    ...
                    <!-- /.box-header -->
				                    <form class="form-horizontal">
				                    	<div class="form-group">
			                                <label for="searchCustNm" class="col-sm-2 control-label">접수번호</label>
			                                <div class="col-sm-2">
			                                	<input type="text" name="searchHpno" class="form-control" readonly id="searchHpno"/>
			                                </div>
			                                <label for="searchCallType" class="col-sm-2 control-label">조치코드</label>
			                                <div class="col-sm-2">
			                                	<input type="text" class="form-control" id="searchCallType"/>
			                                </div>
				                    	</div>
				                    	<div class="form-group">
			                                <label for="searchCustNm" class="col-sm-2 control-label">출동시간</label>
			                                <div class="col-sm-2">
			                                	<input type="text" class="form-control" id="searchCustNm"/>
			                                </div>
			                                <label for="searchCallType" class="col-sm-2 control-label">도착시간</label>
			                                <div class="col-sm-2">
			                                	<input type="text" class="form-control" id="searchCallType"/>
			                                </div>
			                                <label for="searchCustNm" class="col-sm-2 control-label">완료시간</label>
			                                <div class="col-sm-2">
			                                	<input type="text" class="form-control" id="searchCustNm"/>
			                                </div>
				                    	</div>
				                    	<div class="form-group">
			                                <label for="searchCustNm" class="col-sm-2 control-label">기타정보</label>
			                                <div class="col-sm-10">
			                                	<input type="text" class="form-control" id="searchCustNm"/>
			                                </div>
				                    	</div>
							...
							<!-- 조회, 등록, 삭제 버튼 -->
		                    <div class="box-footer text-right">
		                        <button type="button" class="btn btn-info" id="btnCustInsUp"> 접수</button>
