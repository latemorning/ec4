...
<%
  ...
  * @Description : EC4CnsltInBoundReq List 화면
...
$(document).ready(function(){
    ...
    callCnsltTable = $('#callCnsltTable').DataTable({
        ...
        "searching": false,
        "bServerSide": true,
        "sAjaxSource": "<c:url value='/ec4/call/inbd/selectCallCnsltReqList.do'/>",
        "fnServerParams": function(aoData){
            aoData.push(
                    ...
                    {"name": "codeId1", "value": $("#cnsltInBoundMngVO select[name=codeId1] option:selected").val()},
                    {"name": "codeId2", "value": $("#cnsltInBoundMngVO select[name=codeId2] option:selected").val()},
                    {"name": "codeId3", "value": $("#cnsltInBoundMngVO select[name=codeId3] option:selected").val()},
                    {"name": "codeId4", "value": $("#cnsltInBoundMngVO select[name=codeId4] option:selected").val()},
        ...
        "columns": [
            ...
            {"data":"vocKnd" , "defaultContent" : ""},                                     // 4
            {"data":"bussplcNm" , "defaultContent" : ""},                             // 5
            {"data":"rcvDt" , "defaultContent" : ""},                           // 6   4   1
            {"data":"procDt" , "defaultContent" : ""},                                // 7   5
            {"data":"procStat" , "defaultContent" : ""}                                // 8   5
        ]
    });
    ...
    $(".selectCmpl2").on("change", function (e) {
    	$("select[name=codeId3]").val(null).trigger('change');
    	$("select[name=codeId4]").val(null).trigger('change');
    });
    ...
    $(".selectCmpl3").on("change", function (e) {
    	$("select[name=codeId4]").val(null).trigger('change');
    });
    ...
    $(".selectCmpl4").select2({
    	"ajax": {
   		    ...
   		    "data": function (params) {
   		        return {
   		            "upCodeId": $("select[name=codeId3] option:selected").val(),
   		            "cnsltSeCode": "CNSE040",//$("select[name=codeId] option:selected").val()
   		         	"codeNm" : $("input[name=codeNm]").val()
   		        };
   		    }
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="searchCmplCd" class="col-sm-2 control-label">VOC코드</label>
                                <div class="col-sm-2">
                                    <form:select path="codeId1" class="form-control input-sm selectCmpl1">
                                        <form:option value="">-- VOC코드1 --</form:option>
                                        <form:options items="${codeList}" itemValue="code" itemLabel="codeNm"/>
                                    </form:select>
                                    <form:errors cssClass="help-block" path="codeId1" />
                                </div>
                                <div class="col-sm-2">
                                    <form:select path="codeId2" class="form-control input-sm selectCmpl2">
                                        <form:option value="">-- VOC코드2 --</form:option>
                                        <form:options items="${codeList}" itemValue="code" itemLabel="codeNm"/>
                                    </form:select>
                                    <form:errors cssClass="help-block" path="codeId2" />
                                </div>
                                <div class="col-sm-2">
                                    <form:select path="codeId3" class="form-control input-sm selectCmpl3">
                                        <form:option value="">-- VOC코드3 --</form:option>
                                        <form:options items="${codeList}" itemValue="code" itemLabel="codeNm"/>
                                    </form:select>
                                    <form:errors cssClass="help-block" path="codeId3" />
                                </div>
                                <div class="col-sm-2">
                                    <form:select path="codeId4" class="form-control input-sm selectCmpl4">
                                        <form:option value="">-- VOC코드4 --</form:option>
                                        <form:options items="${codeList}" itemValue="code" itemLabel="codeNm"/>
                                    </form:select>
                                    <form:errors cssClass="help-block" path="codeId4" />
                                </div>
                            </div>
                            <div class="form-group">
