        	...
        	<div class="col-md-12"> <!-- DIV 가로영역을 나누는 용도 -->
                        ...
                        <div class="box">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="text01" class="col-sm-2 control-label">상담원명</label>
                                    <div class="col-sm-2">
                                        <div class="input-group">
	                                        <input type="text" name="text01" class="form-control" id="text01"/>
	                                        <div class="input-group-btn">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="text02" class="col-sm-2 control-label">부서</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01" value="2018-04-20"/>
                                    </div>
                                    
                                    <label for="select1" class="col-sm-2 control-label">업무그룹</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01" value="2018-04-20"/>
                                    </div>

                                    <label for="datepicker01" class="col-sm-2 control-label">직급</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="select1" class="col-sm-2 control-label">입사일자</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01" value="2018-04-20"/>
                                    </div>

                                    <label for="datepicker01" class="col-sm-2 control-label">퇴사일자</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                    
                                    <label for="select1" class="col-sm-2 control-label">근무여부</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="datepicker01" class="col-sm-2 control-label">권한</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                    
                                    <label for="select1" class="col-sm-2 control-label">핸드폰</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>

                                    <label for="datepicker01" class="col-sm-2 control-label">집전화</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="select1" class="col-sm-2 control-label">주소</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="datepicker01" class="col-sm-2 control-label">자격증</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="text01" class="form-control" id="text01"/>
                                    </div>
                                </div>
