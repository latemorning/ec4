...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCallScriptInsertAction").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/call/outbd/insertCallScript.do'/>",
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>콜스크립트 등록</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            <form:hidden path="makrCd"/>
                                <div class="box-body">
                                    <div class="form-group">
		                                ...
		                                <div class="control-label">
		                                    <form:select path="scriptKnd" class="form-control input-sm">
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCallScriptInsertAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
