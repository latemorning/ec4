...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCnsltLicenseUpdateAction").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/call/cnslt/updateCnsltLicense.do'/>",
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>상담원자격증 수정</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            ...
                            <form:hidden path="makrCd"/>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
		                                <label for="licenseNo" class="control-label">자격증번호</label>
		                                <div class="control-label">
		                                        <form:input path="licenseNo" cssClass="form-control input-sm" readonly="true"/>
		                                </div>
                                    </div>
                                    <div class="form-group">
		                                <label for="licenseNm" class="control-label">자격증명</label>
		                                <div class="control-label">
		                                        <form:input path="licenseNm" cssClass="form-control input-sm"/>
		                                </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="licenseGetDt" class="control-label">취득일자</label>
                                        <div class="input-group date">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <form:input path="licenseGetDt" cssClass="form-control pull-right input-sm datepicker"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="licenseGrade" class="control-label">등급</label>
                                        <div class="control-label">
		                                        <form:input path="licenseGrade" cssClass="form-control input-sm"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCnsltLicenseUpdateAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
