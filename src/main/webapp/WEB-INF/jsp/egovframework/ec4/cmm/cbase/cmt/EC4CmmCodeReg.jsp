    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCmmCodeInsert").click(function(){
                ...
                // 등록
                frm.action = "<c:url value='/ec4/cmm/cbase/cmt/insertCmmCode.do'/>";
                frm.submit();
            });
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-fw fa-save"></i>공통코드 등록</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form commandName="cmmCodeVO" name="cmmCodeVO" method="post" cssClass="form-horizontal">
                            ...
                            <div class="box-body">
                                <div class="form-group has-warning">
                                    ...
                                    <div class="col-sm-10">
                                        <form:select path="clCode" cssClass="form-control input-sm">
                                            <form:option value="">-- 선택 --</form:option>
                                            <form:options items="${clCodeList}" itemValue="code" itemLabel="codeNm"/>
                                        </form:select>
                                        <form:errors cssClass="help-block" path="clCode" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-warning">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="codeId" cssClass="form-control input-sm" maxlength="30" />
                            ...
                            <div class="box-footer text-right">
                                <button type="button" id="btnCmmCodeInsert" class="btn btn-sm btn-primary">저장</button>
