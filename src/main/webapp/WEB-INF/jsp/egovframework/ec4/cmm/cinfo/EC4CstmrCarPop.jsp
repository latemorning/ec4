...
$(document).ready(function(){
	...
	function searchInfo(){
        ...
        listCstmrTable = $('#listCstmrTable').DataTable({
            ...
            "searching": false,
            "bServerSide": true,
            "sAjaxSource": "/ec4/cmm/cinfo/cstmrCarList.do",
            ...
            "fnServerParams": function(aoData){
                aoData.push(
                        ...
                        {"name": "vin", "value": $("#searchCstmrForm input[name=searchVin]").val()},
                        {"name": "vhcleNo", "value": $("#searchCstmrForm input[name=searchVhcleNo]").val()}
                );
            },
            "sServerMethod": "POST",
            "columnDefs": [
        ...
        $('#listCstmrTable tbody').on('dblclick', 'tr', function () {
			...
			if("" != "${cstmrIntgrMngVO.popupNm}" && null != "${cstmrIntgrMngVO.popupNm}"){
				...
				opener.$("#${cstmrIntgrMngVO.popupNm} input[name=vin]").val(rowData[0].vin);
				opener.$("#${cstmrIntgrMngVO.popupNm} input[name=vhcleNo]").val(rowData[0].vhcleNo);
			}else{
	        	...
	        	opener.$("#searchVin").val(rowData[0].vin);
	        	opener.$("#searchCarNo").val(rowData[0].vhcleNo);
			}
                ...
                <div class="box">
                    ...
                    <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
	                                <input type="text" name="searchVin" class="form-control" id="searchVin" value="${cstmrIntgrMngVO.vin}"/>
                                </div>
