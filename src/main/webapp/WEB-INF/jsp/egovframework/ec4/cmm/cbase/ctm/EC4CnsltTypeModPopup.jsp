...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            /* 상담코드 수정 function */
            $("#btnCnsltTypeUpdate").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/cmm/cbase/ctm/updateCnsltType.do'/>",
                            ...
                            <form:form commandName="cnsltTypeVO" name="cnsltTypeVO" method="post" cssClass="form-horizontal">
                                ...
                                <div class="box-body">
                                    <div class="form-group has-warning">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-control no-border">${cnsltTypeVO.codeId}</div>
                                        </div>
                                    </div>
                                    <div class="form-group has-warning">
                                    ...
                                    <div class="form-group has-warning">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-control no-border">${cnsltTypeVO.cnsltSeNm}</div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCnsltTypeUpdate" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
