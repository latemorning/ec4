...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnCstmrIntgrInsertAction").click(function(){
                ...
                $.ajax({
                    ...
                    "url": "<c:url value='/ec4/cmm/cinfo/insertCstmrIntgrMng.do'/>",
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>고객통합정보 등록</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form:form commandName="popUpMngVO" name="popUpMngVO" method="post" >
                            	<form:hidden path="relKnd" value="I"/>
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnCstmrIntgrInsertAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
