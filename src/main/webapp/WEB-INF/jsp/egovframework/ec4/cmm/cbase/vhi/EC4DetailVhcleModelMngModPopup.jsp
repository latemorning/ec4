...
<%@ taglib prefix="validator"  uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnVhcleDetailModelUpdateAction").click(function(){
                ...
                if(beginDe && endDe){
                    if(endDe < beginDe){
                    	...
                    	alert('<spring:message code="errors.size.compare" arguments="${vhcleDetailModelDateText}"/>');
                    	return;
                    }
                } */
                // -- 기타 처리사항
            ...
            <div class="modal-body">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-fw fa-save"></i>상세모델 수정</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form:form commandName="popUpMngVO" name="popUpMngVO" method="post">
                            <form:hidden path="detailModelId"/>
                                <div class="box-body">
                                    <div class="form-group has-warning">
		                                ...
		                                <div class="control-label">
		                                    ...
		                                    <form:select path="vhcleModelId" class="form-control input-sm selectVhclMdl">
		                                        <c:if test="${popUpMngVO.vhcleModelNm != '' and popUpMngVO.vhcleModelNm != null}">
		                                        	<option value="${popUpMngVO.vhcleModelId}">${popUpMngVO.vhcleModelNm}</option>
		                                        </c:if>
		                                        <c:if test="${popUpMngVO.vhcleModelNm == '' or popUpMngVO.vhcleModelNm == null}">
			                                        <form:option value="">-- 모델 --</form:option>
                                ...
                                <div class="box-footer text-right">
                                    <button type="button" id="btnVhcleDetailModelUpdateAction" class="btn btn-sm btn-primary"><spring:message code="button.save"/></button>
                                </div>
                                <!-- /.box-footer -->
                            </form:form>
                        </div>
