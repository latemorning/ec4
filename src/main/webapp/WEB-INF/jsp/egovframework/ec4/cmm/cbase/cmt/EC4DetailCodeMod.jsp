...
<%--
    Class Name : EC4DetailCodeMod.jsp
    Description : 공통코드 수정
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnDetailCodeUpdate").click(function(){
                ...
                // 수정
                frm.action = "<c:url value='/ec4/cmm/cbase/cmt/updateDetailCode.do'/>";
                frm.submit();
            });
                        ...
                        <form:form commandName="detailCodeVO" name="detailCodeVO" method="post" cssClass="form-horizontal">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-control no-border">${detailCodeVO.codeIdNm}</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-control no-border">${detailCodeVO.code}</div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer text-right">
                                <button type="button" id="btnDetailCodeUpdate" class="btn btn-sm btn-primary">저장</button>
