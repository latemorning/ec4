...
<%
 /**
  * @Class Name : EC4MblMyPointMng.java
  * @Description :
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        <input type="text" class="form-control text-right" id="searchCustNm" value="1,500" readonly/>
                                    </div>
                                </div>
                            </form>
                            </div>
