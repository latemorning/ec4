                        ...
                        <div class="box">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">차계부</button>
	                                    </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">리콜확인</button>
	                                    </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">주기점검</button>
	                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">정비이력</button>
	                                    </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">판매이력</button>
	                                    </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">차량제원</button>
	                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">Auto포인트</button>
	                                    </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="input-group">
	                                        <button type="button" class="btn btn-info">수신함</button>
	                                    </div>
                                    </div>
                                </div>
                            </form>
