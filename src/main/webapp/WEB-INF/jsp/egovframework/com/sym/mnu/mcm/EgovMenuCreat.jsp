...
<!-- Main content -->
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  ...
	  <td width=""><input name="authorCode" type="text" size="30"  maxlength="30" title="권한코드" value="${resultVO.authorCode}" readonly></td>
	  <th width="25%">
	     <table border="0" cellspacing="0" cellpadding="0" align="right">
	       <tr>
	         <td width="10"></td>
	         <td><button type="button" class="btn btn-info" id="btnMenuAct" onclick="fInsertMenuCreat(); return false;" > 메뉴생성</button></td>
	         <!-- <td><span class="button"><a href="#LINK" onclick="fInsertMenuCreat(); return false;">메뉴생성</a></span></td> -->
	         <td width="5%"></td>
	         <td><button type="button" class="btn btn-info" id="btnSiteAct" onclick="fMenuCreatSiteMap(); return false;" > 사이트맵생성</button></td>
