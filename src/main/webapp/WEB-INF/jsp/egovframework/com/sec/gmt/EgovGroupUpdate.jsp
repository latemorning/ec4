                ...
                <div class="box">
					...
					<div class="box-body">
								<div class="form-group has-warning">
									<label for="groupId" class="col-sm-2 control-label">그룹ID</label>
									<div class="col-sm-4">
					                    <form:input path="groupId" class="form-control" readonly="true" title="그룹ID" />
					                    <form:errors path="groupId" cssClass="help-block"/>
									</div>
								</div>
								
								<div class="form-group has-warning">
									<label for="groupNm" class="col-sm-2 control-label">그룹명</label>
									<div class="col-sm-4">
					                    <form:input path="groupNm" class="form-control" maxlength="50" title="그룹명" />
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
					                    <form:input path="groupCreatDe" class="form-control" maxlength="50" title="등록일자" />
