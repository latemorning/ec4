            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-footer text-right">
                      	<button type="button" class="btn btn-info" id="btnSearch" onclick="javascript:fncSelectGroupList('1')" > 조회</button>
                      	<button type="button" class="btn btn-info" id="btnDel" onclick="javascript:fncGroupListDelete()" > 삭제</button>
                      	<button type="button" class="btn btn-info" id="btnList" onclick="javascript:fncAddGroupInsert()" > 등록</button>
                    </div>
		...
		<div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
					...
					<table width="100%" cellpadding="8" class="table table-hover dataTable no-footer" summary="그룹 관리에 관한 테이블입니다.그룹 ID,그룹 명,설명,등록일자의 정보를 담고 있습니다.">
