		...
		<div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
					...
					<!-- content start -->
					<form:form commandName="deptManage" method="post" action="${pageContext.request.contextPath}/uss/umt/dpt/addDeptManage.do' />" enctype="multipart/form-data" cssClass="form-horizontal">
					...
					<div class="box-body">
			                    ...
			                    <div class="box-footer text-right">
			                        <button type="submit" class="btn btn-info" id="btnInsert" onclick="fncDeptManageInsert(); return false;" > 저장</button>
