		...
		<div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
			        ...
			        <!-- content start -->
			        <form:form commandName="userManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovUserSelectUpdt.do" name="userManageVO" method="post" cssClass="form-horizontal">
					...
					<div class="box-body">
			                    ...
			                    <div class="box-footer text-right">
			                        ...
			                        <button type="button" class="btn btn-info" id="btnDelete" onclick="fnDeleteUser('<c:out value='${userManageVO.userTy}'/>:<c:out value='${userManageVO.uniqId}'/>'); return false;" > 삭제</button>
			                        <button type="button" class="btn btn-info" id="btnList" onclick="fnListPage(); return false;" > 목록</button>
			                        <button type="button" class="btn btn-info" id="btnChange" onclick="fnPasswordMove(); return false;" > 암호변경</button>
