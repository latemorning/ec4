...
jwork.fileUpload.prototype.appendFileRow = function(file, isSaved) {
	...
	var fileAreaTableTr =	jQuery("<tr class='fileItem " + trClassName + "' id='"+file.id+"' ></tr>").append(
								...
								jQuery("<td class='text-right' >" + fileSizeStr + "</td>")).append(
								...
								jQuery("<td class='text-center'></td>").append(
									btnDownload)).append(
								jQuery("<td class='text-center' ></td>").append(
									imgButton));
...
jwork.fileUpload.prototype.beforeUpload = function() {
	...
	params.deletedFileSeqList = this.deletedFileSeqList;
	params.beanId = this.beanId;
	params.useSecurity = this.useSecurity;
	params.uploadMode = this.uploadMode;
	params.uploadPathKey = this.uploadPathKey;
